            ...
            <Row>
                ...
                <Col sm="12">
                    <Card title="Colors" code={dividerColors}>
                        <CardText>
                            Use class{" "}
                            <code>.divider-[primary | secondary | success | danger | warnings | info | dark]</code> with{" "}
                            <code>.divider</code> to set text position.
                        </CardText>
                        <DividerColors />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Style" code={dividerStyle}>
                        <CardText>
                            use class <code>.divider-[dotted | dashed]</code> to change divider style. solid is default
                            style you don't have to add any class for it.
                        </CardText>
                        <DividerStyle />
                    </Card>
                </Col>
