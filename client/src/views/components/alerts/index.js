            ...
            <Row>
                <Col sm="12">
                    <Card title="Default" code={defaultAlert}>
                        <CardText>
                            Alerts are available for any length of text, as well as an optional dismiss button. Use{" "}
                            <code>Alert</code> Component & <code>color</code> prop for alert with all theme colors.
                        </CardText>
                        <DefaultAlert />
                    </Card>
                </Col>
                ...
                <Col sm="12">
                    <Card title="Uncontrolled Alert" code={alertUncontrolled}>
                        <CardText>
                            For the most basic use-case an uncontrolled component can provide the functionality wanted
                            without the need to manage/control the state of the component. UncontrolledAlert does not
                            require isOpen nor toggle props to work.
                        </CardText>
                        <AlertUncontrolled />
                    </Card>
                </Col>
