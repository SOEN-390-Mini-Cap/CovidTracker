            ...
            <Row className="match-height">
                ...
                <Col xl="6" lg="12">
                    <Card title="Colors" code={avatarColors}>
                        <CardText className="mb-0">
                            Use prop <code>color=[primary | success | danger | info | warning | dark]</code> to change
                ...
                <Col xl="6" sm="12">
                    <Card title="Avatar Group" code={avatarGroup}>
                        <CardText>
                            Use <code>&lt;AvatarGroup /&gt;</code> component and pass <code>data</code> prop to create a
                            grouped avatar.
                        </CardText>
                        <CardText>
