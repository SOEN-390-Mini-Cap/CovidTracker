            ...
            <Row className="match-height">
                ...
                <Col lg="6" md="12">
                    <Card title="Disabled Items" code={listGroupDisabled}>
                        <CardText>
                            Add <code>disabled</code> prop to a <code>list-group-item</code> to gray it out to appear
                            disabled.
                        </CardText>
                        <ListGroupDisabled />
                    </Card>
                ...
                <Col lg="6" md="12">
                    <Card title="Badges" code={listGroupBadges}>
                        <CardText>
                            Use Utility classes <code>.d-flex</code> & <code>.justify-content-between</code> to create
                ...
                <Col lg="6" md="12">
                    <Card title="Tags List Group" code={listGroupTag}>
                        <CardText>
                            Use <code>tag</code> prop with <code>ListGroupItem</code> tag to change item's tag. You can
                            use <code>active</code> prop with <code>ListGroupItem</code> tag to show an item as active.
                            Use <code>action</code> prop to make your list actionable.
                        </CardText>
                        <ListGroupTags />
                    </Card>
                </Col>
                ...
                <Col lg="6" sm="12">
                    <Card title="Horizontal List Group" code={listGroupHorizontal}>
                        <CardText>
                            Use class <code>.list-group-horizontal</code> to change the layout of list group items from
                            vertical to horizontal across all breakpoints.choose a responsive variant code.{" "}
