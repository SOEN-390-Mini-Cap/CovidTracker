            ...
            <Row>
                ...
                <Col sm="12">
                    <Card code={accordionWithoutArrow} title="Accordion Without Arrow">
                        <CardText>
                            Use class <code>.accordion-without-arrow</code> class with <code>&lt;Accordion&gt;</code>{" "}
                            for accordion without arrow.
                        </CardText>
                        <AccordionWithoutArrow />
                    </Card>
                </Col>
                <Col sm="12">
                    <Card title="Border" code={accordionBorder}>
                        <CardText>
                            Use class <code>.accordion-border</code> class with your accordion to create a bordered
                            accordion.
                        </CardText>
                        <AccordionBorder />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Margin" code={accordionMargin}>
                        <CardText>
                            Use class <code>.accordion-margin</code> class with your accordion to create a accordion
                            with margin.
                        </CardText>
                        <AccordionMargin />
                    </Card>
