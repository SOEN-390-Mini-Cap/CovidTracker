...
const Wizard = forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      <div>
        <Link className="brand-logo pt-2 mb-0" to="/" onClick={(e) => e.preventDefault()}>
          <Logo />
        </Link>
      </div>
      <div className={classnames('bs-stepper-header mx-2', { [headerClassName]: headerClassName })}>{renderHeader()}</div>
